...
private:
  ...
  // ===== Particle Filter =======
  unique_ptr<ParticleFilter> pf; // Object of particle filter class
...
//  double sigma_pos [3] = {1.3, 1.3, 0.11};
  //  double sigma_pos [3] = {0.3, 0.3, 0.11};
    double sigma_pos [3] = {0.05, 0.05, 0.001};
